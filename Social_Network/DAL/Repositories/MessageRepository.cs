...
namespace SocialNetwork.DAL.Repositories
{
    public class MessageRepository : BaseRepository, IMessageRepository
    {
        ...
        {
            return Execute(@"insert into messages(content, sender_id, receiver_id) 
                             values(:content,:sender_id,:receiver_id)", messageEntity);
        }
        ...
        public IEnumerable<MessageEntity> FindByRecipientId(int receiverId)
        {
            return Query<MessageEntity>("select * from messages where receiver_id = :receiver_id", new { receiver_id = receiverId });
        }
